...
<head>
	...
	* { font-family: Apple SD Gothic Neo,Malgun Gothic,arial,sans-serif,arial,sans-serif; }
	...
	.row-button button { padding: 5px 10px; border: 0; background-color: transparent; color: #f28178; font-size: 20px; font-weight: bold; }
	</style>
</head>
<body>
...
<form id="kbaord-comments-confirm-form" method="post" action="<?php echo $submit_action_url?>" onsubmit="return submit_checker(this)">
	...
	<div class="kboard-popup-form">
		<div class="kboard-popup-row"><textarea name="content" rows="5"><?php echo $comment->content?></textarea></div>
