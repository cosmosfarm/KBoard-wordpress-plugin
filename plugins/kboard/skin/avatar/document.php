<div id="kboard-avatar-document">
	...
	<div class="kboard-control">
		<div class="left">
			...
			<?php if(!$content->notice):?><a href="<?php echo $url->set('parent_uid', $content->uid)->set('mod', 'editor')->toString()?>" class="kboard-button-small"><?php echo __('Reply', 'kboard')?></a><?php endif?>
		</div>
