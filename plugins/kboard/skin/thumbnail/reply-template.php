...
<tr class="<?php if($content->uid == kboard_uid()):?>kboard-list-selected<?php endif?>">
	...
	<td class="kboard-list-thumbnail">
		...
		<?php if($content->getThumbnail(320, 180)):?><img src="<?php echo esc_url($content->getThumbnail(320, 180))?>" alt=""><?php else:?><span class="kboard-icon-thumbnail"></span><?php endif?>
		</a>
	</td>
	<td class="kboard-list-title" style="padding-left:<?php echo ($depth+1)*5?>px">
		<a href="<?php echo esc_url($url->getDocumentURLWithUID($content->uid))?>">
			<div class="kboard-mobile-contents">
				<?php if($content->getThumbnail(200, 150)):?><img src="<?php echo esc_url($content->getThumbnail(200, 150))?>" alt="" class="contents-thumbnail"><?php endif?>
			</div>
