...
<?php elseif($field['field_type'] == 'content'):?>
	<div class="kboard-attr-row">
		<label class="attr-name" for="kboard_content"><?php echo $field_name?> <span class="attr-required-text">*</span></label>
...
<?php elseif($field['field_type'] == 'nonmember'):?>
	...
	<div class="kboard-attr-row">
		<label class="attr-name" for="kboard-input-member-display"><?php echo __('Author', 'kboard')?> <span class="attr-required-text">*</span></label>
...
<?php elseif($field['field_type'] == 'attach'):?>
	<?php if($board->meta->max_attached_count > 0):?>
		...
		<div class="kboard-attr-row">
			<label class="attr-name" for="kboard-input-file<?php echo $attached_index?>"><span class="field-name"><?php echo $field_name?></span><?php echo $attached_index?></label>
			<div class="attr-value">
...
<?php elseif($field['field_type'] == 'tree_category'):?>
	<?php if($board->isTreeCategoryActive()):?>
		<div class="kboard-attr-row <?php echo $field['class']?> <?php echo $required?>">
			<label class="attr-name" for="<?php echo esc_attr($meta_key)?>"><span class="field-name"><?php echo $field_name?></span></label>
			<div class="attr-value">
...
<div class="kboard-attr-row <?php echo $field['class']?>">
	<label class="attr-name" for="<?php echo esc_attr($meta_key)?>"><span class="field-name"><?php echo $field_name?></span> <span class="attr-required-text">*</span></label>
	<div class="attr-value">
...
<?php else:?>
<div class="kboard-attr-row <?php echo $field['class']?> <?php echo $required?>">
	<label class="attr-name" for="<?php echo esc_attr($meta_key)?>"><?php echo esc_html($field_name)?><?php if($required):?> <span class="attr-required-text">*</span><?php endif?></label>
	<div class="attr-value">
