...
class ContentList {
	...
	public function getAllList(){
		$this->total = reset(mysql_fetch_row(mysql_query("SELECT COUNT(*) FROM kboard_board_content WHERE board_id LIKE '$this->board_id'")));
		$this->resource = mysql_query("SELECT * FROM kboard_board_content WHERE board_id LIKE '$this->board_id' ORDER BY date DESC");
	...
	public function initWithRSS(){
		$resource = mysql_query("SELECT uid FROM kboard_board_setting WHERE permission_read='all'");
	...
	public function getNoticeList(){
		...
		$this->resource_notice = mysql_query("SELECT * FROM kboard_board_content WHERE " . implode(" AND ", $where) . " ORDER BY date DESC");
