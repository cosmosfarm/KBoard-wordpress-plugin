...
----------------------------------
  ...
  4. 신규 댓글 알림 기능 추가
  5. 작성자명 저장 방법 기능 추가
  6. 댓글 작성자명 저장 방법 기능 추가
  7. 기간 내 게시글만 표시하기 기능 추가
  8. 최신글 리스트에 추가로 표시할 정보 기능 추가
  9. 작성자 활동 보기 설정 추가
  10. 관리자 페이지 전체 게시글 기간 설정 필터 추가
  11. 관리자 페이지 전체 댓글 기간 설정 필터 추가
  12. 관리자 답글 알림 제외
  13. csv 파일 다운로드 입력 필드 데이터 내용에 삽입 기능 추가
  14. 공지사항 만료 기간 기능 추가
  15. 카테고리 탭 추가 카테고리 기본 설정 카테고리 탭으로 이동
  16. 입력필드 탭에서 게시글본문 표시하기 설정 셀렉트문으로 개선
  17. 번역 파일 로드 방식 변경
  18. 버그 수정
