...
<div class="wrap">
	...
	<form id="kboard-setting-form" action="<?php echo admin_url('admin-post.php')?>" method="post" enctype="multipart/form-data">
		...
		<h2 class="nav-tab-wrapper">
			...
			<?php if($board->id):?>
			<a href="#tab-kboard-setting-2" class="tab-kboard nav-tab" onclick="kboard_setting_tab_chnage(2);">입력필드 설정</a>
			<a href="#tab-kboard-setting-3" class="tab-kboard nav-tab" onclick="kboard_setting_tab_chnage(3);">계층형 카테고리</a>
			...
			<div class="kboard-fields-wrap">
					...
					<li class="kboard-fields-default left">
						...
						<ul class="kboard-fields-list kboard-fields-content">
							...
							<li class="default <?php echo $key?>">
								<input type="hidden" name="" value="<?php echo $item['class']?>" class="field_data class">
								<div class="kboard-extends-fields">
									...
									<div class="kboard-fields-toggle">
										<button type="button" class="fields-remove">X</button>
									</div>
								</div>
								<div class="kboard-fields-content">
									<input type="hidden" name="" class="field_data field_type" value="<?php echo $item['field_type']?>">
									<input type="hidden" name="" class="field_data field_label" value="<?php echo $item['field_label']?>">
									<?php if(isset($item['option_field'])):?>
										<input type="hidden" name="" class="field_data option_field" value="<?php echo $item['option_field']?>">
									<?php endif?>
									<div class="attr-row">
										<label class="attr-name">필드 레이블</label>
										<div class="attr-value">
											<input type="text" name="" class="field_data field_name" value="<?php if(isset($item['field_name']) && $item['field_name']):echo $item['field_name']; endif?>">
										</div>
									</div>
									...
									<div class="attr-row">
										...
										<div class="attr-value">
											<select name="" class="field_data roles" onchange="kboard_fields_permission_roles_view(this)">
											...
											<div class="kboard-permission-read-roles-view kboard-hide">
												<?php foreach(get_editable_roles() as $roles_key=>$roles_value):?>
													<label><input type="checkbox" name="" class="field_data roles_checkbox" value="<?php echo $roles_key?>"<?php if($roles_key=='administrator'):?> onclick="return false" checked<?php endif?>><?php echo _x($roles_value['name'], 'User role')?></label>
												<?php endforeach?>
											</div>
										</div>
									</div>
									...
									<div class="attr-row">
										...
										<div class="attr-value">
											...
											<div class="kboard-permission-read-roles-view kboard-hide">
												<?php foreach(get_editable_roles() as $roles_key=>$roles_value):?>
													<label><input type="checkbox" name="" class="field_data" value="<?php echo $roles_key?>"<?php if($roles_key=='administrator'):?> onclick="return false" checked<?php endif?>><?php echo _x($value['name'], 'User role')?></label>
												<?php endforeach?>
											</div>
										</div>
									</div>
									<div class="attr-row">
										...
										<div class="attr-value">
											...
											<div class="kboard-permission-read-roles-view<?php if($item['permission'] != 'roles'):?> kboard-hide<?php endif?>">
												<?php foreach(get_editable_roles() as $roles_key=>$roles_value):?>
													<label><input type="checkbox" name="" class="field_data" value="<?php echo $roles_key?>"<?php if($roles_key=='administrator'):?> onclick="return false"<?php endif?><?php if($roles_key=='administrator' || in_array($roles_key, $item['roles'])):?> checked<?php endif?>><?php echo _x($roles_value['name'], 'User role')?></label>
												<?php endforeach?>
											</div>
										</div>
									</div>
									<div class="attr-row">
										<label class="attr-name">새로운 댓글 알림</label>
										<div class="attr-value">
											<select name="" class="field_data roles" onchange="kboard_fields_permission_roles_view(this)">
												<option value="all" selected>제한없음</option>
												<option value="author">로그인 사용자</option>
											...
											<div class="kboard-permission-read-roles-view<?php if($board->permission_read != 'roles'):?> kboard-hide<?php endif?>">
												<?php foreach(get_editable_roles() as $option_key=>$option_value):?>
													<label><input type="checkbox" name="" class="field_data" value="<?php echo $option_key?>"<?php if($option_key=='administrator'):?> onclick="return false"<?php endif?><?php if($option_key=='administrator' || in_array($option_key, $item['roles'])):?> checked<?php endif?>><?php echo _x($roles_value['name'], 'User role')?></label>
												<?php endforeach?>
											</div>
										</div>
									</div>
									...
									<?php if(isset($item['default_value'])):?>
										<div class="attr-row">
											...
											<?php if($item['field_type'] == 'search'):?>
												<select name="" class="field_data default_value">
											...
											<?php elseif($item['field_type'] == 'category1'):?>
												<?php if($board->initCategory1()):?>
													<select id="<?php echo $key?>" name="" class="field_data default_value">
											...
											<?php elseif($item['field_type'] == 'category2'):?>
												...
												<?php endif?>
											<?php else:?>
												<input type="text" name="" class="field_data default_value">
											<?php endif?>
											</div>
										</div>
									<?php endif?>
									...
									<div class="attr-row">
										...
										<div class="attr-value"><input type="text" name="" class="field_data placeholder" value="<?php if(isset($item['placeholder']) && $item['placeholder']):echo $item['placeholder']; endif?>"></div>
									</div>
									<?php endif?>
									...
									<div class="attr-row">
										...
										<div class="attr-value">
											<input type="text" name="" class="field_data field_description" value="<?php echo $item['description']?>">
										</div>
									</div>
									<?php endif?>
									<?php if(isset($item['required']) || isset($item['show_document']) || isset($item['hidden'])):?>
										...
										<?php if(isset($item['required'])):?>
											<label>
												<input type="hidden" name="" class="field_data required" value="">
												<input type="checkbox" name="" class="field_data required" value="1"<?php if($item['required']):?> checked<?php endif?>>필수
											</label>
										<?php endif?>
										<?php if(isset($item['show_document'])):?>
											<label>
												<input type="hidden" name="" class="field_data show_document" value="">
												<input type="checkbox" name="" class="field_data show_document" value="1"<?php if($item['show_document']):?> checked<?php endif?>>게시글 본문에 표시
											</label>
										<?php endif?>
										<?php if(isset($item['hidden'])):?>
											<label>
												<input type="hidden" name="" class="field_data hidden" value="">
												<input type="checkbox" name="" class="field_data hidden" value="1"<?php if($item['hidden']):?> checked<?php endif?>>숨김
											</label>
										<?php endif?>
										</div>
									<?php endif?>
						...
						<?php if($extens_field):?>
							...
							<li class="extends <?php echo $key?>">
								...
								<div class="kboard-fields-content">
									...
									<div class="attr-row">
										<label class="attr-name">필드 레이블</label>
										<div class="attr-value"><input type="text" name="" class="field_data field_name" placeholder="제목"></div>
									</div>
									<?php if(isset($item['meta_key'])):?>
									<div class="attr-row">
										<label class="attr-name">메타키</label>
										<div class="attr-value"><input type="text" name="" class="field_data meta_key" placeholder="meta_key"></div>
									...
									<?php if(isset($item['row'])):?>
										<div class="attr-row option-wrap">
											...
											<div class="attr-value">
												<input type="text" name="" class="field_data option_label">
									...
									<div class="attr-row">
										<label class="attr-name">기본값</label>
										<div class="attr-value"><input type="text" name="" class="field_data default_value"></div>
									</div>
									<?php endif?>
									<?php if(isset($item['placeholder'])):?>
									<div class="attr-row">
										<label class="attr-name">placeholder</label>
										<div class="attr-value"><input type="text" name="" class="field_data placeholder"></div>
									</div>
									<?php endif?>
									<?php if(isset($item['description'])):?>
									<div class="attr-row">
									...
									<div class="attr-row">
										<?php if(isset($item['required'])):?>
										<input type="hidden" name="" class="field_data required" value="">
										<label><input type="checkbox" name="" class="field_data required" value="1">필수</label>
										<?php endif?>
										<?php if(isset($item['show_document'])):?>
										<input type="hidden" name="" class="field_data show_document" value="">
										<label><input type="checkbox" name="" class="field_data show_document" value="1">게시글 본문에 표시</label>
										<?php endif?>
										<?php if(isset($item['hidden'])):?>
										<input type="hidden" name="" class="field_data hidden" value="">
										<label><input type="checkbox" name="" class="field_data hidden" value="1">숨김</label>
										<?php endif?>
									</div>
								</div>
							</li>
				...
				<div class="kboard-fields kboard-sortable-fields">
					...
					<ul class="kboard-fields-sortable connected-sortable">
						...
						<li class="<?php echo $board->fields()->isDefaultFields($item['field_type'])?> <?php echo $meta_key?>">
							<input type="hidden" class="parent_id" value="<?php echo $meta_key?>">
							<input type="hidden" name="fields[<?php echo $meta_key?>][class]" class="field_data class" value="<?php echo $item['class']?>"> 
							...
							<div class="kboard-fields-content">
								<input type="hidden" name="fields[<?php echo $meta_key?>][field_type]" class="field_data field_type" value="<?php echo $item['field_type']?>">
								<input type="hidden" name="fields[<?php echo $meta_key?>][field_label]" class="field_data field_label" value="<?php echo $item['field_label']?>">
								<?php if(isset($item['option_field'])):?>
									<input type="hidden" name="fields[<?php echo $meta_key?>][option_field]" class="field_data option_field" value="1">
								<?php endif?>
								<?php if(isset($item['hidden'])):?>
									<input type="text" name="fields[<?php echo $meta_key?>][hidden]" class="field_data hidden" value="1">
								<?php endif?>
								<?php if(isset($item['field_name'])):?>
								<div class="attr-row">
									<label class="attr-name">필드 레이블</label>
									<div class="attr-value">
										<input type="text" name="fields[<?php echo $meta_key?>][field_name]" class="field_data field_name" value="<?php echo $item['field_name']?$item['field_name']:$item['field_label'] ?>">
									</div>
								</div>
								<?php endif?>
								<?php if(isset($item['meta_key'])):?>
								<div class="attr-row">
									<label class="attr-name">메타키</label>
									<div class="attr-value">
										<input type="text" name="fields[<?php echo $meta_key?>][meta_key]" class="field_data meta_key" value="<?php echo $item['meta_key']?$item['meta_key']:$meta_key?>"<?php if($item['meta_key'] || $meta_key):?> readonly<?php endif?> placeholder="meta_key">
									</div>
									<div class="description">※ 입력하지 않으면 자동으로 설정되며 저장 이후에는 값을 변경할 수 없습니다.</div>
								</div>
								<?php endif?>
								<?php if(isset($item['row'])):?>
									<?php if($board->fields()->getRow($item['row'])):?>
										...
										<?php if(isset($option_value['label']) && $option_value['label']):?>
											<div class="attr-row option-wrap">
												...
												<div class="attr-value">
													<input type="text" name="fields[<?php echo $meta_key?>][row][<?php echo $option_key?>][label]" class="field_data option_label" value="<?php echo $option_value['label']?>">
													<button type="button" class="<?php echo $item['field_type']?>" onclick="add_option(this)">+</button>
													<button type="button" class="<?php echo $item['field_type']?>" onclick="remove_option(this)">-</button>
													<?php if($item['field_type'] == 'checkbox'):?>
													<input type="checkbox" name="fields[<?php echo $meta_key?>][row][<?php echo $option_key?>][default_value]" class="field_data default_value"<?php if(isset($option_value['default_value']) && $option_value['default_value'] == '1'):?> checked<?php endif?> value="1">
													<?php else:?>
													<input type="radio" name="fields[<?php echo $meta_key?>][default_value]" class="field_data default_value"<?php if($item['default_value'] == $option_key):?> checked<?php endif?> value="<?php echo $option_key?>">
													<?php endif?>
													기본값
												</div>
											</div>
									...
									<?php else:?>
										...
										<div class="attr-row option-wrap">
											...
											<div class="attr-value">
												<input type="text" name="fields[<?php echo $meta_key?>][row][<?php echo $uniq_id?>][label]" class="field_data option_label" value="">
												<button type="button" class="<?php echo $item['field_type']?>" onclick="add_option(this)">+</button>
												<button type="button" class="<?php echo $item['field_type']?>" onclick="remove_option(this)">-</button>
												<?php if($item['field_type'] == 'checkbox'):?>
												<input type="checkbox" name="fields[<?php echo $meta_key?>][row][<?php echo $uniq_id?>][default_value]" class="field_data default_value" value="">
												<?php else:?>
												<input type="radio" name="fields[<?php echo $meta_key?>][default_value]" class="field_data default_value" value="">
												<?php endif?>
												기본값
											</div>
										</div>
								...
								<div class="attr-row">
									<label class="attr-name">표시할 권한</label>
									<div class="attr-value">
										<select name="fields[<?php echo $meta_key?>][permission]" class="field_data roles" onchange="kboard_fields_permission_roles_view(this)">
										...
										<div class="kboard-permission-read-roles-view<?php if($item['permission'] != 'roles'):?> kboard-hide<?php endif?>">
											<?php foreach(get_editable_roles() as $roles_key=>$roles_value):?>
												<label><input type="checkbox" name="fields[<?php echo $meta_key?>][roles][]" class="field_data" value="<?php echo $roles_key?>"<?php if($roles_key=='administrator'):?> onclick="return false"<?php endif?><?php if($roles_key=='administrator' || in_array($roles_key, $item['roles'])):?> checked<?php endif?>><?php echo _x($roles_value['name'], 'User role')?></label>
											<?php endforeach?>
										</div>
									</div>
								</div>
								...
								<div class="attr-row">
									<label class="attr-name">비밀글</label>
									<div class="attr-value">
										<select name="fields[option][secret_permission]" class="field_data roles" onchange="kboard_fields_permission_roles_view(this)">
											<option value="all" selected>제한없음</option>
											<option value="author">로그인 사용자</option>
											<option value="roles">직접선택</option>
										</select>
								...
								<div class="attr-row">
									<label class="attr-name">공지사항</label>
									<div class="attr-value">
										<select name="fields[option][notice_permission]" class="field_data roles" onchange="kboard_fields_permission_roles_view(this)">
											<option value="all" selected>제한없음</option>
											<option value="author">로그인 사용자</option>
											<option value="roles">직접선택</option>
										</select>
								...
								<div class="attr-row">
									<label class="attr-name">새로운 댓글 알림</label>
									<div class="attr-value">
										<select name="fields[option][comment_permission]" class="field_data roles" onchange="kboard_fields_permission_roles_view(this)">
											<option value="all" selected>제한없음</option>
											<option value="author">로그인 사용자</option>
											<option value="roles">직접선택</option>
										</select>
								...
								<?php if(isset($item['default_value']) && $item['field_type'] != 'checkbox' && $item['field_type'] != 'radio' && $item['field_type'] != 'select' && $item['field_type'] != 'ip'):?>
									<div class="attr-row">
										...
										<div class="attr-value">
										<?php if($item['field_type'] == 'search'):?>
											<select name="fields[search][default_value]" class="field_data default_value">
										...
										<?php elseif($item['field_type'] == 'category1'):?>
											<?php if($board->initCategory1()):?>
												<select id="<?php echo $meta_key?>" name="fields[category1][default_value]" class="field_data default_value">
													<option value=""><?php echo __('Category', 'kboard')?> <?php echo __('Select', 'kboard')?></option>
													<?php while($board->hasNextCategory()):?>
													<option value="<?php echo $board->currentCategory()?>"<?php if($item['default_value'] == $board->currentCategory()):?> selected<?php endif?>><?php echo $board->currentCategory()?></option>
													<?php endwhile?>
										...
										<?php elseif($item['field_type'] == 'category2'):?>
											<?php if($board->initCategory2()):?>
												<select id="<?php echo $meta_key?>" name="fields[category2][default_value]" class="field_data default_value">
													<option value=""><?php echo __('Category', 'kboard')?> <?php echo __('Select', 'kboard')?></option>
													<?php while($board->hasNextCategory()):?>
													<option value="<?php echo $board->currentCategory()?>"<?php if($item['default_value'] == $board->currentCategory()):?> selected<?php endif?>><?php echo $board->currentCategory()?></option>
													<?php endwhile?>
											...
											<?php endif?>
										<?php else:?>
											<input type="text" name="fields[<?php echo $meta_key?>][default_value]" class="field_data default_value" value="<?php echo $item['default_value']?>">
										<?php endif?>
										</div>
									</div>
								<?php endif?>
								...
								<div class="attr-row">
									<label class="attr-name">placeholder</label>
									<div class="attr-value"><input type="text" name="fields[<?php echo $meta_key?>][placeholder]" class="field_data placeholder" value="<?php echo $item['placeholder']?>"></div>
								</div>
								<?php endif?>
								<?php if(isset($item['description'])):?>
								<div class="attr-row">
									<label class="attr-name">설명</label>
									<div class="attr-value">
										<input type="text" name="fields[<?php echo $meta_key?>][description]" class="field_data field_description" value="<?php echo $item['description']?>">
									</div>
									<?php if($item['field_type'] == 'title'):?>
								...
								<div class="attr-row">
									<?php if(isset($item['required'])):?>
										<label>
											<input type="hidden" name="fields[<?php echo $meta_key?>][required]" class="field_data required" value="">
											<input type="checkbox" name="fields[<?php echo $meta_key?>][required]" class="field_data required" value="1"<?php if($item['required']):?> checked<?php endif?>>필수
										</label>
									<?php endif?>
									<?php if(isset($item['show_document'])):?>
										<label>
											<input type="hidden" name="fields[<?php echo $meta_key?>][show_document]" class="field_data show_document" value="">
											<input type="checkbox" name="fields[<?php echo $meta_key?>][show_document]" class="field_data show_document" value="1"<?php if($item['show_document']):?> checked<?php endif?>>게시글 본문에 표시
										</label>
									<?php endif?>
									<?php if(isset($item['hidden'])):?>
										<label>
											<input type="hidden" name="fields[<?php echo $meta_key?>][hidden]" class="field_data hidden" value="">
											<input type="checkbox" name="fields[<?php echo $meta_key?>][hidden]" class="field_data hidden" value="1"<?php if($item['hidden']):?> checked<?php endif?>>숨김
										</label>
									<?php endif?>
								</div>
								<?php endif?>
